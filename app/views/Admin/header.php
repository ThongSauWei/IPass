    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/IPass/app/views/Admin/dashboard.view.php">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost/IPass/app/views/Admin/dashboard.view.php">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if (SessionManager::superAdmin()) : ?>
                                ...
                                <a class="collapse-item" href="http://localhost/IPass/app/views/Admin/User/displayStaff.php">Display All Staff</a>
                                <a class="collapse-item" href="http://localhost/IPass/app/views/Admin/User/addStaff.php">Create Staff</a>
                                
                            <?php endif; ?>
                            <h6 class="collapse-header">Customer:</h6>
                            <a class="collapse-item" href="http://localhost/IPass/app/views/Admin/User/displayCustomer.php">Display All Customer</a>
                        </div>
                    </div>
                </li>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="http://localhost/IPass/app/views/Admin/AdminProfile.php">
